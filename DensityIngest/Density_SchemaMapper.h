...
#ifndef Density_Density_SchemaMapper_h
#define Density_Density_SchemaMapper_h

using namespace DBDataSchema;

namespace Density {
    
    class DensitySchemaMapper : public SchemaDataMapGenerator  {
    ...
    public:
        ...
        DensitySchemaMapper(DBAsserter::AsserterFactory * newAssertFac, DBConverter::ConverterFactory * newConvFac);
